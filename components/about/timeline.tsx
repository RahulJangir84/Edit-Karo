...
export default function Timeline() {
 ...
 <div className="absolute left-[11px] md:left-1/2 w-3 h-3 bg-slate-light rounded-full md:-translate-x-1/2 mt-6 md:mt-0 shadow-[0_0_15px_rgba(164,181,190,0.8)] z-10" />
 ...
 <span className="text-slate-medium font-bold tracking-widest text-sm uppercase mb-2 block">
 {item.year}
 </span>
