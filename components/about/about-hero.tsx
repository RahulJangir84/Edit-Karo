...
export default function AboutHero() {
 ...
 <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-slate-medium/10 rounded-full blur-[120px] pointer-events-none" />
 <div className="absolute bottom-0 left-0 w-[40vw] h-[40vw] bg-slate-dark/10 rounded-full blur-[120px] pointer-events-none" />
 ...
 <div className="w-16 h-16 rounded-2xl glass flex items-center justify-center mb-8 border border-white/10 group-hover:border-slate-light/50 transition-colors duration-500">
 <Target className="w-8 h-8 text-slate-light" />
 </div>
 ...
 <Eye className="w-8 h-8 text-slate-dark" />
 </div>
 ...
 <div className="w-16 h-16 rounded-2xl glass flex items-center justify-center mb-8 border border-white/10 group-hover:border-slate-medium/50 transition-colors duration-500">
 <ShieldCheck className="w-8 h-8 text-slate-medium" />
 </div>
