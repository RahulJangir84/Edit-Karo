...
export function AccordionItem({ question, answer, isOpen, onClick }: AccordionItemProps) {
 ...
 isOpen ? "text-slate-light" : "text-white group-hover:text-gray-300"
 )}>
 {question}
 </span>
 <div className={cn(
 "w-10 h-10 rounded-full glass border border-white/10 flex items-center justify-center transition-all duration-300",
 isOpen ? "bg-slate-light/10 border-slate-light/30 text-slate-light rotate-180" : "text-gray-400 group-hover:border-white/30"
 )}>
