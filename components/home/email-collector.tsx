...
export default function EmailCollector() {
 ...
 <div className="absolute inset-0 bg-gradient-to-r from-slate-medium/10 via-slate-dark/10 to-slate-light/10 rounded-3xl blur-2xl -z-10" />
 ...
 >
 <div className="absolute top-0 right-0 w-64 h-64 bg-slate-medium/20 rounded-full blur-[100px] pointer-events-none" />
