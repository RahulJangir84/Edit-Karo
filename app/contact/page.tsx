...
export default function ContactPage() {
 ...
 <div className="w-12 h-12 rounded-full glass flex items-center justify-center border border-white/10 group-hover:border-slate-light/50 group-hover:text-slate-light transition-colors">
 ...
 <div className="flex items-center gap-4 group">
 <div className="w-12 h-12 rounded-full glass flex items-center justify-center border border-white/10 group-hover:border-slate-dark/50 group-hover:text-slate-dark transition-colors">
 ...
 <div className="flex items-center gap-4 group">
 <div className="w-12 h-12 rounded-full glass flex items-center justify-center border border-white/10 group-hover:border-slate-medium/50 group-hover:text-slate-medium transition-colors">
 ...
 <div className="absolute top-0 right-0 w-64 h-64 bg-slate-light/10 rounded-full blur-[100px] pointer-events-none" />
